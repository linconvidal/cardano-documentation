...
| [Cardano GraphQL](https://github.com/cardano-foundation/cardano-graphql) | [8.2.0](https://github.com/cardano-foundation/cardano-graphql/releases/tag/8.2.0)            | 5 Aug, 2024     |
